<template>
            ...
            <div class="md:flex gap-4 justify-between w-full">
                <div class="md:w-[50%] pt-4">
                    ...
                    <div class="text-[#999999] text-sm">
                        ...
                        Reviews, Blog, Seller Portal, BLACK FRIDAY, TOKO
                        Assistant
                    </div>
                </div>
                <div class="md:w-[50%] pt-4">
                    ...
                    <div class="text-[#999999] text-sm">
                        TOKO Group Website, TOKO, Alimama, Alipay, Fliggy, TOKO
                        Cloud, TOKO International, AliTelecom, DingTalk,
                        Juhuasuan, Taobao Marketplace, Tmall, Taobao Global,
                        AliOS, 1688
                    </div>
                </div>
            </div>
    ...
    <div id="FooterSub" class="w-full bg-[#333333] text-sm text-gray-400">
        <div class="max-w-[1200px] mx-auto p-4">
            ...
            Guide ©️2010-2022 TOKO.com. All rights reserved.
